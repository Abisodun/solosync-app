      ...
      <div className="w-full" style={{
        ...
        <div className="w-full max-w-full" style={{ padding: '0 8px' }}>
              ...
              <Card className="p-6 rounded-[20px]" style={{ background: 'linear-gradient(135deg, rgba(167, 139, 250, 0.1) 0%, rgba(147, 197, 253, 0.1) 100%)' }}>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-bold text-gray-800 mb-3">💡 AI Productivity Tip</h3>
                    {loadingTip ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 sm:gap-6 mb-8">
              {[
                ...
                return (
                  ...
                  >
                    <Card className="p-5 rounded-[20px]" style={{ background: 'rgba(255, 255, 255, 0.95)', boxShadow: '0 8px 32px rgba(167, 139, 250, 0.15)' }}>
              ...
              <Card className="p-6 rounded-[20px]" style={{ background: 'rgba(255, 255, 255, 0.95)', boxShadow: '0 8px 32px rgba(167, 139, 250, 0.15)' }}>
                ...
                <div className="space-y-4">
                  {goals.filter(g => g.status === 'active').slice(0, 3).map((goal) => (
                    <div key={goal.id} className="p-4 rounded-[12px] bg-gray-50">
              ...
              <Card className="p-6 rounded-[20px]" style={{ background: 'rgba(255, 255, 255, 0.95)', boxShadow: '0 8px 32px rgba(167, 139, 250, 0.15)' }}>
                ...
                <div className="space-y-4">
                  {activeHabits.slice(0, 4).map((habit) => (
                    <div key={habit.id} className="p-4 rounded-[12px] bg-gray-50">
                      <div className="flex items-center justify-between">
                        <div className="flex-1">
                          <h4 className="font-semibold text-gray-800 text-sm">{habit.name}</h4>
                          <p className="text-xs text-gray-500 capitalize mt-1">{habit.frequency}</p>
                        </div>
          ...
          {preferences.show_recent_tasks && (
            <Card className="p-6 rounded-[20px] mb-8" style={{ background: 'rgba(255, 255, 255, 0.95)', boxShadow: '0 8px 32px rgba(167, 139, 250, 0.15)' }}>
              <h3 className="text-lg font-bold text-gray-800 mb-6">Recent Tasks</h3>
              <div className="space-y-3">
                {activeTasks.slice(0, 5).map((task) => (
                  <div key={task.id} className="flex items-center justify-between p-4 rounded-[12px] bg-gray-50">
                    <div className="flex-1">
